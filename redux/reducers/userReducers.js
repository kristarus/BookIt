...
export const forgotPasswordReducer = (state = { loading: false, user: null }, action) => {
  switch (action.type) {
...
export const resetPasswordReducer = (state = { loading: false, user: null }, action) => {
  switch (action.type) {
...
export const allUsersReducer = (state = { loading: true, user: [] }, action) => {
  switch (action.type) {
